      ...
      builder: (context, snapshot) {
        ...
        return Consumer<ThemeService>(
          builder: (context, themeService, child) {
            ...
            '/asset_protection': (context) => const AssetProtectionIntroScreen(),
            '/asset_protection_intro': (context) => const AssetProtectionIntroScreen(),
            '/asset_protection_health': (context) => const HealthCoverScreen(),
            '/asset_protection_vehicle': (context) => const VehicleCoverScreen(),
            '/asset_protection_home': (context) => const HomeCoverScreen(),

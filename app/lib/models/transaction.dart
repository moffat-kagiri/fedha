...
class Transaction {
  ...
  String? get goalId => null;

  /// Description getter that maps to notes field for backward compatibility
  String? get description => notes;

  /// Description setter that maps to notes field for backward compatibility
  set description(String? value) {
    // Cannot set final field, this is for interface compatibility only
    // The notes field should be set through constructor
  }

  /// Updated at timestamp (maps to date for now)
  DateTime get updatedAt => date;

  /// Updated at setter (placeholder for interface compatibility)
...
enum TransactionCategory {
  ...
  clothing,
  dining,
  utilities, // Maps to Django's 'OTHR'
}

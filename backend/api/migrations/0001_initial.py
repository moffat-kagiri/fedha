# Generated by Django 4.2.23 on 2025-11-29 15:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "description",
                    models.TextField(
                        blank=True, help_text="Detailed description of category usage"
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="Client business or individual name", max_length=200
                    ),
                ),
                (
                    "email",
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=1,
                        help_text="Encryption key version used for encrypted fields",
                    ),
                ),
            ...
            bases=(api.models.EncryptedFieldsMixin, models.Model),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "description",
                    models.CharField(
                        help_text="Brief description of the transaction", max_length=255
                    ),
                ),
                (
                    "notes",
                    models.TextField(blank=True, help_text="Detailed notes or memo"),
                ),
                (
                    "reference_number",
                    models.CharField(
                ...
                ("receipt_url_encrypted", models.BinaryField(blank=True, null=True)),
                (
                    "encryption_version",
                    models.PositiveIntegerField(
                        default=1,
                ...
                (
                    "receipt_url",
                    models.URLField(
                        blank=True, help_text="URL to uploaded receipt or document"
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "total_amount",
                    models.DecimalField(
                        decimal_places=2, help_text="Final invoice total", max_digits=15
                    ),
                ),
                (
                    "paid_amount",
                ...
                (
                    "notes",
                    models.TextField(
                        blank=True, help_text="Internal notes visible on invoice"
                    ),
                ),
                (
                ...
                (
                    "currency",
                    models.CharField(
                        default="USD", help_text="Invoice currency", max_length=3
                    ),
                ),
                (
                    "template_name",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "description",
                    models.CharField(
                        help_text="Product or service description", max_length=255
                    ),
                ),
                (
                    "quantity",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("fields_reencrypted", models.JSONField(blank=True, default=list)),
                (
                    "status",
                    models.CharField(
                        choices=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("lender_encrypted", models.BinaryField(blank=True, null=True)),
                (
                    "encryption_version",
                    models.PositiveIntegerField(
                        default=1,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "profile_type",
                    models.CharField(
                        choices=[("BIZ", "Business"), ("PERS", "Personal")],
                        default="PERS",
        ...
        migrations.AddIndex(
            model_name="profile",
            index=models.Index(
                fields=["profile_type"], name="api_profile_profile_5452a2_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="profile",
            index=models.Index(
                fields=["created_at"], name="api_profile_created_7369c0_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="profile",
            index=models.Index(
                fields=["is_active"], name="api_profile_is_acti_77260e_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="profile",
            index=models.Index(
                fields=["user_id"], name="api_profile_user_id_bc09a5_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="profile",
            index=models.Index(fields=["email"], name="api_profile_email_ed681b_idx"),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                to="api.recurringtransactiontemplate",
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["profile", "tax_year"], name="api_taxreco_profile_d3ec59_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="taxrecord",
            index=models.Index(
                fields=["jurisdiction", "tax_year"],
                name="api_taxreco_jurisdi_8508d7_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="taxrecord",
            index=models.Index(
                fields=["record_type", "tax_year"],
                name="api_taxreco_record__a5a495_idx",
            ),
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["profile", "setting_type"],
                name="api_systems_profile_549d66_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="systemsetting",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["profile", "is_active"], name="api_recurri_profile_63f027_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="recurringtransactiontemplate",
            index=models.Index(
                fields=["next_due_date"], name="api_recurri_next_du_8b60b3_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="recurringtransactiontemplate",
            index=models.Index(
                fields=["auto_generate"], name="api_recurri_auto_ge_35a8be_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="loanpayment",
            index=models.Index(
                fields=["loan", "payment_number"], name="api_loanpay_loan_id_cd58a6_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="loanpayment",
            index=models.Index(
                fields=["scheduled_date"], name="api_loanpay_schedul_c4fe28_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="loanpayment",
            index=models.Index(
                fields=["is_paid"], name="api_loanpay_is_paid_08ac5c_idx"
            ),
        ),
        migrations.AlterUniqueTogether(
            name="loanpayment",
        ...
        migrations.AddIndex(
            model_name="loan",
            index=models.Index(
                fields=["profile", "status"], name="api_loan_profile_1ec237_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="loan",
            index=models.Index(
                fields=["maturity_date"], name="api_loan_maturit_e3ec84_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="loan",
            index=models.Index(
                fields=["loan_type"], name="api_loan_loan_ty_68d320_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="invoice",
            index=models.Index(
                fields=["profile", "status"], name="api_invoice_profile_1d4569_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="invoice",
            index=models.Index(
                fields=["client", "status"], name="api_invoice_client__b56705_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="invoice",
            index=models.Index(
                fields=["due_date"], name="api_invoice_due_dat_8d5d97_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="invoice",
        ...
        migrations.AddIndex(
            model_name="invoice",
            index=models.Index(
                fields=["issue_date"], name="api_invoice_issue_d_b078ad_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="goal",
            index=models.Index(
                fields=["profile", "status"], name="api_goal_profile_6c9e6a_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="goal",
            index=models.Index(
                fields=["target_date"], name="api_goal_target__67a108_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="goal",
            index=models.Index(
                fields=["goal_type"], name="api_goal_goal_ty_675423_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="financialratio",
            index=models.Index(
                fields=["profile", "ratio_type"], name="api_financi_profile_652624_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="financialratio",
            index=models.Index(
                fields=["calculation_date"], name="api_financi_calcula_35ac27_idx"
            ),
        ),
        migrations.AlterUniqueTogether(
            name="financialratio",
        ...
        migrations.AddIndex(
            model_name="enhancedtransaction",
            index=models.Index(
                fields=["profile", "date"], name="api_enhance_profile_9cc1aa_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="enhancedtransaction",
            index=models.Index(
                fields=["type", "date"], name="api_enhance_type_91a6ed_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="enhancedtransaction",
            index=models.Index(
                fields=["category", "date"], name="api_enhance_categor_734512_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="enhancedtransaction",
            index=models.Index(
                fields=["client", "date"], name="api_enhance_client__403d53_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="enhancedtransaction",
            index=models.Index(
                fields=["is_tax_relevant"], name="api_enhance_is_tax__848a60_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="enhancedtransaction",
            index=models.Index(
                fields=["is_reconciled"], name="api_enhance_is_reco_77d306_idx"
            ),
        ),
        migrations.AlterUniqueTogether(
            name="encryptionkeyversion",
        ...
        migrations.AddIndex(
            model_name="client",
            index=models.Index(
                fields=["profile", "is_active"], name="api_client_profile_54afa2_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="client",
        ...
        migrations.AddIndex(
            model_name="category",
            index=models.Index(
                fields=["profile", "type"], name="api_categor_profile_b27421_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="category",
        ...
        migrations.AddIndex(
            model_name="category",
            index=models.Index(
                fields=["is_system_default"], name="api_categor_is_syst_c3a182_idx"
            ),
        ),
        migrations.AlterUniqueTogether(
            name="category",
        ...
        migrations.AddIndex(
            model_name="budget",
            index=models.Index(
                fields=["profile", "status"], name="api_budget_profile_92dcbf_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="budget",
            index=models.Index(
                fields=["start_date", "end_date"], name="api_budget_start_d_7f0b56_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="auditlog",
            index=models.Index(
                fields=["profile", "timestamp"], name="api_auditlo_profile_d1059e_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="auditlog",
            index=models.Index(
                ...
                name="api_auditlo_action__fb81b2_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="auditlog",
            index=models.Index(
                ...
                name="api_auditlo_table_n_8b45a5_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="asset",
            index=models.Index(
                fields=["profile", "asset_type"], name="api_asset_profile_39a820_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="asset",
            index=models.Index(
                fields=["purchase_date"], name="api_asset_purchas_130291_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="asset",
            index=models.Index(
                fields=["is_active"], name="api_asset_is_acti_dfa117_idx"
            ),
        ),
    ]
